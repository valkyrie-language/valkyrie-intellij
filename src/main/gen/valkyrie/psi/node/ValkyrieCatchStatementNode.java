...
public class ValkyrieCatchStatementNode extends ValkyrieElement implements ValkyrieCatchStatement {

    public ValkyrieCatchStatementNode(@NotNull ASTNode node) {
        super(node);
    }
