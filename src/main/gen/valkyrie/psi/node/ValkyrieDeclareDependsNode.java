...
public class ValkyrieDeclareDependsNode extends ValkyrieElement implements ValkyrieDeclareDepends {

    public ValkyrieDeclareDependsNode(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ValkyrieVisitor visitor) {
        visitor.visitDeclareDepends(this);
    }
