...
public class ValkyrieDeclareTemplateNode extends ValkyrieElement implements ValkyrieDeclareTemplate {

    public ValkyrieDeclareTemplateNode(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ValkyrieVisitor visitor) {
        visitor.visitDeclareTemplate(this);
    }
