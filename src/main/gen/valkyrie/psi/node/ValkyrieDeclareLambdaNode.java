...
public class ValkyrieDeclareLambdaNode extends ValkyrieElement implements ValkyrieDeclareLambda {

    public ValkyrieDeclareLambdaNode(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ValkyrieVisitor visitor) {
        visitor.visitDeclareLambda(this);
    }
