...
public class YggdrasilParser implements PsiParser, LightPsiParser {
    ...
    /* ********************************************************** */
    // KW_CATCH inline-expression match-body
    ...
    /* ********************************************************** */
    // KW_LET pattern type-hint? EQUAL block-statement
    ...
    /* ********************************************************** */
    // OP_AND_THEN? DOT KW_CATCH match-body
    public static boolean dot_call_catch(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dot_call_catch")) return false;
        if (!nextTokenIs(b, "<dot call catch>", DOT, OP_AND_THEN)) return false;
        boolean r, p;
        Marker m = enter_section_(b, l, _NONE_, DOT_CALL_CATCH, "<dot call catch>");
        r = dot_call_catch_0(b, l + 1);
        r = r && consumeTokens(b, 2, DOT, KW_CATCH);
        p = r; // pin = 3
    ...
    // OP_AND_THEN?
    private static boolean dot_call_catch_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dot_call_catch_0")) return false;
        consumeToken(b, OP_AND_THEN);
        return true;
    }
    ...
    /* ********************************************************** */
    // KW_FOR (pattern-bare|pattern) KW_IN inline-expression block-body otherwise-statement?
    public static boolean for_statement(PsiBuilder b, int l) {
        ...
        r = p && for_statement_5(b, l + 1) && r;
        exit_section_(b, l, m, r, p, null);
        return r || p;
    }

    // pattern-bare|pattern
    ...
    /* ********************************************************** */
    // KW_IF inline-expression block-body else-if-statement* else-statement?
    ...
    public static boolean is_not(PsiBuilder b, int l) {
        ...
        r = r && is_not_1(b, l + 1);
        exit_section_(b, m, IS_NOT, r);
        return r;
    }

    // KW_NOT?
    private static boolean is_not_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "is_not_1")) return false;
    ...
    /* ********************************************************** */
    // KW_CASE pattern COLON block-bare
    ...
    /* ********************************************************** */
    // KW_ELSE inline-expression COLON block-bare
    ...
    public static boolean pattern(PsiBuilder b, int l) {
        ...
        if (!r) r = pattern_term(b, l + 1);
        exit_section_(b, l, m, r, false, null);
        return r;
    }

    /* ********************************************************** */
    // pattern-term (COMMA pattern-term)* COMMA?
    ...
    /* ********************************************************** */
    // annotations identifier-free
    public static boolean pattern_term(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "pattern_term")) return false;
        boolean r;
    ...
    /* ********************************************************** */
    // namepath-free? PARENTHESIS_L pattern-bare PARENTHESIS_R
    public static boolean pattern_unapply(PsiBuilder b, int l) {
        ...
        r = pattern_unapply_0(b, l + 1);
        r = r && consumeToken(b, PARENTHESIS_L);
        r = r && pattern_bare(b, l + 1);
        r = r && consumeToken(b, PARENTHESIS_R);
        exit_section_(b, l, m, r, false, null);
        return r;
    }
    ...
    // namepath-free?
    private static boolean pattern_unapply_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "pattern_unapply_0")) return false;
        namepath_free(b, l + 1);
        return true;
    }
    ...
    /* ********************************************************** */
    // OP_BANG | OP_AND_THEN | dot-call | dot-call-catch | dot-call-match | generic-call
    ...
    public static boolean type_infix(PsiBuilder b, int l) {
        ...
        if (!nextTokenIs(b, OP_PLUS)) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = consumeToken(b, OP_PLUS);
    ...
    /* ********************************************************** */
    // while-kind inline-expression block-body otherwise-statement?
    public static boolean while_statement(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "while_statement")) return false;
        if (!nextTokenIs(b, "<while statement>", KW_UNTIL, KW_WHILE)) return false;
        boolean r, p;
