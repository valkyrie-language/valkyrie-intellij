...
public class YggdrasilParser implements PsiParser, LightPsiParser {
    ...
    public static boolean KW_FUNCTION(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "KW_FUNCTION")) return false;
        boolean r;
        Marker m = enter_section_(b, l, _NONE_, KW_FUNCTION, "<kw function>");
        r = consumeToken(b, KW_MICRO);
    ...
    /* ********************************************************** */
    // declare-depends? annotations KW_CLASS identifier declare-depends? class-inherit? type-hint? class-body
    ...
    /* ********************************************************** */
    // annotations KW_COMPONENT identifier declare-depends? class-inherit? type-hint? class-body
    ...
    /* ********************************************************** */
    // annotations KW_DEPENDS (identifier (COMMA identifier)* COMMA?)? template-body
    public static boolean declare_depends(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends")) return false;
        boolean r, p;
        Marker m = enter_section_(b, l, _NONE_, DECLARE_DEPENDS, "<declare depends>");
        r = annotations(b, l + 1);
        r = r && consumeToken(b, KW_DEPENDS);
        p = r; // pin = 2
        r = r && report_error_(b, declare_depends_2(b, l + 1));
    ...
    private static boolean declare_depends_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends_2")) return false;
        declare_depends_2_0(b, l + 1);
        return true;
    }

    // identifier (COMMA identifier)* COMMA?
    private static boolean declare_depends_2_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends_2_0")) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = identifier(b, l + 1);
        r = r && declare_depends_2_0_1(b, l + 1);
        r = r && declare_depends_2_0_2(b, l + 1);
        exit_section_(b, m, null, r);
        return r;
    }

    // (COMMA identifier)*
    private static boolean declare_depends_2_0_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends_2_0_1")) return false;
        while (true) {
            int c = current_position_(b);
            if (!declare_depends_2_0_1_0(b, l + 1)) break;
            if (!empty_element_parsed_guard_(b, "declare_depends_2_0_1", c)) break;
        }
        return true;
    }

    // COMMA identifier
    private static boolean declare_depends_2_0_1_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends_2_0_1_0")) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = consumeToken(b, COMMA);
        r = r && identifier(b, l + 1);
    ...
    // COMMA?
    private static boolean declare_depends_2_0_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_depends_2_0_2")) return false;
        consumeToken(b, COMMA);
        return true;
    }
    ...
    /* ********************************************************** */
    // annotations KW_MICRO declare-depends? identifier parameter-body return-type? effect-type? block-body
    ...
    /* ********************************************************** */
    // annotations KW_IMPLY declare-depends? (
    //     // impl class: trait
    ...
    /* ********************************************************** */
    // annotations KW_MACRO declare-depends? identifier parameter-body return-type? effect-type? block-body
    ...
    /* ********************************************************** */
    // annotations KW_FUNCTION? identifier-free declare-depends? parameter-body return-type? effect-type? block-body?
    ...
    /* ********************************************************** */
    // annotations KW_MEZZO declare-depends? identifier parameter-body return-type? effect-type? block-body
    public static boolean declare_mezzo(PsiBuilder b, int l) {
        ...
        r = p && report_error_(b, declare_mezzo_6(b, l + 1)) && r;
        r = p && block_body(b, l + 1) && r;
        exit_section_(b, l, m, r, p, null);
        return r || p;
    }
    ...
    // effect-type?
    private static boolean declare_mezzo_6(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_mezzo_6")) return false;
        effect_type(b, l + 1);
        return true;
    }
    ...
    /* ********************************************************** */
    // annotations KW_NEURAL identifier declare-depends? class-inherit? type-hint? class-body
    ...
    /* ********************************************************** */
    // annotations KW_SINGLETON identifier declare-depends? class-inherit? type-hint? class-body
    ...
    /* ********************************************************** */
    // annotations KW_TRAIT identifier declare-depends? type-hint? class-body
    ...
    /* ********************************************************** */
    // annotations KW_TYPE identifier declare-depends? EQUAL type-expression
    public static boolean declare_type(PsiBuilder b, int l) {
        ...
        p = r; // pin = 2
        r = r && report_error_(b, identifier(b, l + 1));
        r = p && report_error_(b, declare_type_3(b, l + 1)) && r;
    ...
    // declare-depends?
    private static boolean declare_type_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "declare_type_3")) return false;
        declare_depends(b, l + 1);
        return true;
    }
    ...
    /* ********************************************************** */
    // declare-depends? annotations KW_UNITE identifier declare-depends? unite-body
    ...
    /* ********************************************************** */
    // KW_LOOP loop-condition? control-label? attribute-below*
    public static boolean loop_start(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_start")) return false;
        if (!nextTokenIs(b, KW_LOOP)) return false;
        boolean r, p;
        Marker m = enter_section_(b, l, _NONE_, LOOP_START, null);
        r = consumeToken(b, KW_LOOP);
        p = r; // pin = 1
        r = r && report_error_(b, loop_start_1(b, l + 1));
        r = p && report_error_(b, loop_start_2(b, l + 1)) && r;
        r = p && loop_start_3(b, l + 1) && r;
        exit_section_(b, l, m, r, p, null);
        return r || p;
    }
    ...
    // attribute-below*
    private static boolean loop_start_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_start_3")) return false;
        while (true) {
            int c = current_position_(b);
            if (!attribute_below(b, l + 1)) break;
            if (!empty_element_parsed_guard_(b, "loop_start_3", c)) break;
        }
        return true;
    }

    /* ********************************************************** */
    // loop-start block-body else-statement? {
    // }
    ...
    /* ********************************************************** */
    // TEMPLATE_L loop-start TEMPLATE_R statements* (template-else statements*)? template-end {
    // }
    public static boolean loop_template(PsiBuilder b, int l) {
        ...
        r = r && loop_template_4(b, l + 1);
        r = r && template_end(b, l + 1);
        r = r && loop_template_6(b, l + 1);
    ...
    private static boolean loop_template_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_template_3")) return false;
        while (true) {
            int c = current_position_(b);
            if (!statements(b, l + 1)) break;
            if (!empty_element_parsed_guard_(b, "loop_template_3", c)) break;
        }
        return true;
    }

    // (template-else statements*)?
    private static boolean loop_template_4(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_template_4")) return false;
        loop_template_4_0(b, l + 1);
        return true;
    }

    // template-else statements*
    private static boolean loop_template_4_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_template_4_0")) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = template_else(b, l + 1);
        r = r && loop_template_4_0_1(b, l + 1);
        exit_section_(b, m, null, r);
        return r;
    }

    // statements*
    private static boolean loop_template_4_0_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "loop_template_4_0_1")) return false;
        while (true) {
            int c = current_position_(b);
            if (!statements(b, l + 1)) break;
            if (!empty_element_parsed_guard_(b, "loop_template_4_0_1", c)) break;
        }
        return true;
    }
    ...
    // {
    // }
    private static boolean loop_template_6(PsiBuilder b, int l) {
        return true;
    }
    ...
    /* ********************************************************** */
    // KW_LAMBDA declare-depends? parameter-body return-type? effect-type?
    ...
    /* ********************************************************** */
    // TEMPLATE_L KW_ELSE keywords? TEMPLATE_R
    public static boolean template_else(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "template_else")) return false;
        if (!nextTokenIs(b, TEMPLATE_L)) return false;
        boolean r;
        Marker m = enter_section_(b);
        r = consumeTokens(b, 0, TEMPLATE_L, KW_ELSE);
        r = r && template_else_2(b, l + 1);
        r = r && consumeToken(b, TEMPLATE_R);
        exit_section_(b, m, TEMPLATE_ELSE, r);
        return r;
    }

    // keywords?
    private static boolean template_else_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "template_else_2")) return false;
        keywords(b, l + 1);
        return true;
    }
