...
public interface ValkyrieTypes {
    ...
    IElementType DECLARE_INFER = new ValkyrieElementType("DECLARE_INFER");
    ...
    IElementType DECLARE_TYPE = new ValkyrieElementType("DECLARE_TYPE");
    ...
    IElementType DOT_CALL_MACRO = new ValkyrieElementType("DOT_CALL_MACRO");
    ...
    IElementType IDENTIFIER_SAFE = new ValkyrieElementType("IDENTIFIER_SAFE");
    ...
    IElementType INFER_BODY = new ValkyrieElementType("INFER_BODY");
    IElementType INFER_ITEM = new ValkyrieElementType("INFER_ITEM");
    IElementType INFIX = new ValkyrieElementType("INFIX");
    IElementType INFIX_GREATER = new ValkyrieElementType("INFIX_GREATER");
    IElementType INFIX_GREATER_EQUAL = new ValkyrieElementType("INFIX_GREATER_EQUAL");
    ...
    IElementType MATCH_KIND = new ValkyrieElementType("MATCH_KIND");
    ...
    IElementType MATCH_WITH_CONTROL = new ValkyrieElementType("MATCH_WITH_CONTROL");
    IElementType MATCH_WITH_PROVIDE = new ValkyrieElementType("MATCH_WITH_PROVIDE");
    ...
    IElementType NAMEPATH_SAFE = new ValkyrieElementType("NAMEPATH_SAFE");
    ...
    IElementType PREFIX_DEREF = new ValkyrieElementType("PREFIX_DEREF");
    IElementType PREFIX_NOT = new ValkyrieElementType("PREFIX_NOT");
    IElementType PREFIX_REF = new ValkyrieElementType("PREFIX_REF");
    ...
    IElementType TYPE_FUNCTION = new ValkyrieElementType("TYPE_FUNCTION");
    ...
    IElementType CEIL_L = new ValkyrieTokenType("CEIL_L");
    IElementType CEIL_R = new ValkyrieTokenType("CEIL_R");
    ...
    IElementType FLOOR_L = new ValkyrieTokenType("FLOOR_L");
    ...
    IElementType KW_INFER = new ValkyrieTokenType("KW_INFER");
    ...
    IElementType LOGIC_AND = new ValkyrieTokenType("LOGIC_AND");
    IElementType LOGIC_NAND = new ValkyrieTokenType("LOGIC_NAND");
    IElementType LOGIC_NOR = new ValkyrieTokenType("LOGIC_NOR");
    IElementType LOGIC_OR = new ValkyrieTokenType("LOGIC_OR");
    IElementType LOGIC_XAND = new ValkyrieTokenType("LOGIC_XAND");
    ...
    IElementType OP_DIV_CEIL = new ValkyrieTokenType("OP_DIV_CEIL");
    IElementType OP_DIV_FLOOR = new ValkyrieTokenType("OP_DIV_FLOOR");
    ...
    IElementType OP_LABEL = new ValkyrieTokenType("OP_LABEL");
    ...
    IElementType OP_REM_ASSIGN = new ValkyrieTokenType("OP_REM_ASSIGN");
    IElementType OP_RR = new ValkyrieTokenType("OP_RR");
    IElementType OP_SET_THEN = new ValkyrieTokenType("OP_SET_THEN");
    IElementType OP_SQRT = new ValkyrieTokenType("OP_SQRT");
    IElementType OP_SUB = new ValkyrieTokenType("OP_SUB");
    IElementType OP_SUB_ASSIGN = new ValkyrieTokenType("OP_SUB_ASSIGN");
    IElementType OP_SURD3 = new ValkyrieTokenType("OP_SURD3");
    IElementType OP_SURD4 = new ValkyrieTokenType("OP_SURD4");
