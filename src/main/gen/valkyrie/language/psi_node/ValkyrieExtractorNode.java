...
public class ValkyrieExtractorNode extends ValkyrieASTBase implements ValkyrieExtractor {

  public ValkyrieExtractorNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ValkyrieVisitor visitor) {
    visitor.visitExtractor(this);
  }
  ...
  @Override
  @NotNull
  public List<ValkyriePatternValue> getPatternValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ValkyriePatternValue.class);
  }
