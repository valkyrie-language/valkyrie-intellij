...
public class ValkyrieParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // case_expression (PATTERN_AND case_expression)*
  public static boolean case_and(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_and")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CASE_AND, "<case and>");
    r = case_expression(b, l + 1);
    r = r && case_and_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // (PATTERN_AND case_expression)*
  private static boolean case_and_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_and_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!case_and_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "case_and_1", c)) break;
    }
    return true;
  }

  // PATTERN_AND case_expression
  private static boolean case_and_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_and_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PATTERN_AND);
    r = r && case_expression(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  /* ********************************************************** */
  // COLON (normal_statements [SEMICOLON])*
  ...
  // normal_statements [SEMICOLON]
  private static boolean case_block_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_block_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = normal_statements(b, l + 1);
    r = r && case_block_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // [SEMICOLON]
  private static boolean case_block_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_block_1_0_1")) return false;
    consumeToken(b, SEMICOLON);
    return true;
  }

  /* ********************************************************** */
  // inline_expression | extractor
  public static boolean case_expression(PsiBuilder b, int l) {
    ...
    if (!r) r = extractor(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  /* ********************************************************** */
  // case_and (PATTERN_OR case_and)*
  public static boolean case_or(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_or")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CASE_OR, "<case or>");
    r = case_and(b, l + 1);
    r = r && case_or_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  ...
  // (PATTERN_OR case_and)*
  private static boolean case_or_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_or_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!case_or_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "case_or_1", c)) break;
    }
    return true;
  }

  // PATTERN_OR case_and
  private static boolean case_or_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "case_or_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PATTERN_OR);
    r = r && case_and(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // match_case OP_SET inline_expression | inline_expression
  ...
  // match_case OP_SET inline_expression
  ...
  /* ********************************************************** */
  // namepath <<parenthesis pattern_value COMMA>> | namepath <<brace_block pattern_pair COMMA>> {
  // //    mixin="valkyrie.language.mixin.MixinCasePattern"
  // }
  public static boolean extractor(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extractor")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, EXTRACTOR, "<extractor>");
    r = extractor_0(b, l + 1);
    if (!r) r = extractor_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // namepath <<parenthesis pattern_value COMMA>>
  private static boolean extractor_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extractor_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = namepath(b, l + 1);
  ...
  // //    mixin="valkyrie.language.mixin.MixinCasePattern"
  // }
  private static boolean extractor_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "extractor_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = namepath(b, l + 1);
    r = r && brace_block(b, l + 1, ValkyrieParser::pattern_pair, COMMA_parser_);
    r = r && extractor_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // //    mixin="valkyrie.language.mixin.MixinCasePattern"
  // }
  private static boolean extractor_1_2(PsiBuilder b, int l) {
    return true;
  }
  ...
  /* ********************************************************** */
  // KW_LET extractor PATTERN_SET normal_statements
  ...
  private static boolean let_statement_0(PsiBuilder b, int l) {
    ...
    r = r && extractor(b, l + 1);
    r = r && consumeToken(b, PATTERN_SET);
  ...
  private static boolean let_statement_1(PsiBuilder b, int l) {
    ...
    r = r && let_statement_1_2(b, l + 1);
    r = r && let_statement_1_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // [let_type]
  private static boolean let_statement_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "let_statement_1_2")) return false;
    let_type(b, l + 1);
    return true;
  }

  // [OP_SET normal_statements]
  private static boolean let_statement_1_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "let_statement_1_3")) return false;
    let_statement_1_3_0(b, l + 1);
    return true;
  }

  // OP_SET normal_statements
  private static boolean let_statement_1_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "let_statement_1_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, OP_SET);
    r = r && normal_statements(b, l + 1);
  ...
  public static boolean match_else(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, KW_ELSE);
    r = r && match_else_1(b, l + 1);
    exit_section_(b, m, MATCH_ELSE, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // match_case | match_else | match_with
  ...
  /* ********************************************************** */
  // KW_WITH identifier (COMMA identifier)*
  public static boolean match_with(PsiBuilder b, int l) {
    ...
    r = r && identifier(b, l + 1);
    r = r && match_with_2(b, l + 1);
    exit_section_(b, m, MATCH_WITH, r);
    return r;
  }

  // (COMMA identifier)*
  private static boolean match_with_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "match_with_2")) return false;
    while (true) {
      int c = current_position_(b);
      if (!match_with_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "match_with_2", c)) break;
    }
    return true;
  }

  // COMMA identifier
  private static boolean match_with_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "match_with_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && identifier(b, l + 1);
  ...
  //     | OP_AND | OP_AND2
  //     | PATTERN_AND | PATTERN_OR | PATTERN_SET
  //     // is | is not
  ...
  static boolean op_binary(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, PATTERN_AND);
    if (!r) r = consumeToken(b, PATTERN_OR);
    if (!r) r = consumeToken(b, PATTERN_SET);
