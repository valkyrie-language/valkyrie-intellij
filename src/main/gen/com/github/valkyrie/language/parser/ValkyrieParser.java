...
public class ValkyrieParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // KW_LET? [maybe_modifier] object_key [COLON expression] [OP_SET expression] | object_key
  ...
  /* ********************************************************** */
  // KW_CLASS [maybe_modifier] identifier [generic_define] [class_inherit] (class_tuple|class_block|COLON)
  ...
  /* ********************************************************** */
  // KW_FOR (case_pattern|normal_pattern) OP_IN expression [if_guard] block [else_statement]
  ...
  /* ********************************************************** */
  // (KW_LOOP | KW_WHILE condition) block
