...
public class ValkyrieParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (class_numeric_key | modifiers) COLON type_expr [BIND expression]
  ...
  /* ********************************************************** */
  // <<brace_block (type_expr COLON type_expr) (COMMA|SEMICOLON)>>
