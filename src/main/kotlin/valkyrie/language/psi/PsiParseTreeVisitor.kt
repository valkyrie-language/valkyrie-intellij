...
open class PsiParseTreeVisitor<T> : PsiElementVisitor(), ParseTreeVisitor<T> {
    /**
     * {@inheritDoc}
     *
     *
     ...
     */
    private fun aggregateResult(aggregate: T?, nextResult: T): T {
        return nextResult
    }
     ...
     */
    private fun shouldVisitNextChild(node: RuleNode?, currentResult: T?): Boolean {
        return true
    }
}