...
import valkyrie.language.dialect_markup.ValkyrieMarkLanguage
import valkyrie.language.dialect_markup.ValkyrieMarkupLexer
import valkyrie.psi.lexers.ValkyrieTokenTypes
import valkyrie.psi.nodes.ValkyrieFileNode
import valkyrie.psi.parsers.ValkyrieParser

/**
 * Valkyrie Mark 语言解析器定义
 */
class ValkyrieMarkParserDefinition : ParserDefinition {

    companion object {
        val FILE = IFileElementType(ValkyrieMarkLanguage)
        val STRING_LITERALS = TokenSet.create(ValkyrieTokenTypes.STRING_DQ, ValkyrieTokenTypes.STRING_MQ)
    }

    override fun createLexer(project: Project?): Lexer = ValkyrieMarkupLexer()
