...
class ValkyrieXmlLexerTest {
    ...
    fun testBasicXmlTag() {
        ...
        // <
        assertEquals(
            "First token should be TAG_START",
        ...
        lexer.advance()
        assertEquals(
            "Second token should be TAG_NAME",
        ...
        lexer.advance()
        assertEquals(
            "Fourth token should be XML_DATA_CHARACTERS",
        ...
        lexer.advance()
        assertEquals(
            "Fifth token should be END_TAG_START",
        ...
        lexer.advance()
        assertEquals(
            "Sixth token should be TAG_NAME",
            XmlTokenType.XML_TAG_NAME, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Seventh token should be TAG_END",
            XmlTokenType.XML_TAG_END, lexer.tokenType
        )
    ...
    fun testXmlWithAttributes() {
        ...
        lexer.advance()
        assertEquals(
            "Third token should be WHITE_SPACE",
        ...
        lexer.advance()
        assertEquals(
            "Fourth token should be XML_ATTRIBUTE_NAME",
            XmlTokenType.XML_NAME, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Sixth token should be XML_ATTRIBUTE_VALUE",
        ...
        lexer.advance()
        assertEquals(
            "Seventh token should be WHITE_SPACE",
            com.intellij.psi.TokenType.WHITE_SPACE, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Eighth token should be XML_ATTRIBUTE_NAME",
            XmlTokenType.XML_NAME, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Tenth token should be XML_ATTRIBUTE_VALUE",
            XmlTokenType.XML_ATTRIBUTE_VALUE_TOKEN, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Eleventh token should be TAG_END",
            XmlTokenType.XML_TAG_END, lexer.tokenType
        )
    }
    ...
    fun testSelfClosingTag() {
        ...
        lexer.advance()
        assertEquals(
            "Eighth token should be EMPTY_ELEMENT_END",
    ...
    fun testNestedXmlTags() {
        ...
        lexer.advance()
        assertEquals(
            "Fourth token should be TAG_START",
            XmlTokenType.XML_START_TAG_START, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Eighth token should be XML_DATA_CHARACTERS",
            XmlTokenType.XML_DATA_CHARACTERS, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Ninth token should be END_TAG_START",
            XmlTokenType.XML_END_TAG_START, lexer.tokenType
        )

        lexer.advance()
        assertEquals(
            "Tenth token should be TAG_NAME",
            XmlTokenType.XML_TAG_NAME, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Twelfth token should be XML_DATA_CHARACTERS",
            XmlTokenType.XML_DATA_CHARACTERS, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Thirteenth token should be END_TAG_START",
            XmlTokenType.XML_END_TAG_START, lexer.tokenType
        )

        lexer.advance()
        assertEquals(
            "Fourteenth token should be TAG_NAME",
            XmlTokenType.XML_TAG_NAME, lexer.tokenType
        )
        ...
        lexer.advance()
        assertEquals(
            "Fifteenth token should be TAG_END",
            XmlTokenType.XML_TAG_END, lexer.tokenType
        )
    }
    ...
    fun testXmlWithWhitespace() {
        ...
        lexer.advance()
        assertEquals(
            "Fifth token should be TAG_START",
            XmlTokenType.XML_START_TAG_START, lexer.tokenType
        )
